...
## thyroid data ----------------------------------------------------------
thyroid_inc_mor<-read.csv("C:/Users/ftich/OneDrive/Plocha/Research 2022_/Kari_LFP/melanoma/source_data/inc_mor_melanoma.csv",sep=",")
...
tidy_df <- thyroid_inc_mor %>% pivot_longer(-year, names_to = "outcome", values_to = "value")
