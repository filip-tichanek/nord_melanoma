...
## melanoma data -------------
melanoma_1y<-read.csv("C:/Users/ftich/OneDrive/Plocha/Research 2022_/Kari_LFP/melanoma/source_data/melanoma_1y.csv",sep=";")
melanoma_5y<-read.csv("C:/Users/ftich/OneDrive/Plocha/Research 2022_/Kari_LFP/melanoma/source_data/melanoma_5y.csv",sep=";")
...
prior_summary(melanoma_5y_model)
sd(melanoma$surv_5y)
