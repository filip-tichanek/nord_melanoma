...
## melanoma data -------------
urlfile <- "https://raw.githubusercontent.com/filip-tichanek/nord_melanoma/main/source_data/melanoma_1y.csv"
melanoma_1y <- read.csv(url(urlfile), sep = ';')

urlfile <- "https://raw.githubusercontent.com/filip-tichanek/nord_melanoma/main/source_data/melanoma_5y.csv"
